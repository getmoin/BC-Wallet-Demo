...
export const CreateNewStep = () => {
  ...
  const handleAddStep = (isIssue: boolean) => {
    ...
    createStep(
      isIssue
        ? createServiceStep({
            title: isIssue ? `Issue Credential with ${personaName}` : 'Information Step',
            description: isIssue
  ...
  return (
    <>
      ...
      <div className="py-2">
        ...
        >
          <p className="text-xl font-bold w-1/4">{t('onboarding.create_basic_step_label') || 'Basic Step'}</p>
          <div className="w-1/4">
            <ul className="mx-5">
          ...
          <p className="text-xl font-bold text-end flex items-center gap-1">
            {t('onboarding.create_add_step_label') || 'Add Step'} <ArrowRight strokeWidth={3} />
          </p>
        </button>
        ...
        >
          <p className="text-xl font-bold w-1/4">{t('onboarding.create_issue_step_label') || 'Issue Step'}</p>
          <div className="w-1/4">
            <ul className="mx-5">
              <li>{t('onboarding.create_title_label') || 'Title'}</li>
              <li>{t('onboarding.create_description_label') || 'Description'}</li>
