...
export const createDefaultStep = ({ title, description }: { title: string; description: string }): StepRequestType => ({
  title,
  description,
  order: 0,
  type: 'HUMAN_TASK',
...
export const createServiceStep = ({ title, description }: { title: string; description: string }): StepRequestType => ({
  title,
  description,
  order: 0,
  type: 'SERVICE',
