...
export declare function PresentationFlowsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): PresentationFlowsResponse;
export declare function PresentationFlowsResponseToJSON(json: any): PresentationFlowsResponse;
export declare function PresentationFlowsResponseToJSONTyped(value?: PresentationFlowsResponse | null, ignoreDiscriminator?: boolean): any;
